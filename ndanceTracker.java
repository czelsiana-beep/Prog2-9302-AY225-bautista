...
/**
 * LAB Work 1 - ndance Tracker Application
 * A Java Swing application for tracking student ndance
 */
public class ndanceTracker {
    
    public static void main(String[] args) {
        // Create frame on Event Dispatch Thread
        SwingUtilities.invokeLater(() -> {
            // Create JFrame window
            JFrame frame = new JFrame("ndance Tracker");
            ...
            // ndance Name label and text field
            gbc.gridx = 0;
            gbc.gridy = 0;
            gbc.anchor = GridBagConstraints.EAST;
            frame.add(new JLabel("ndance Name:"), gbc);
